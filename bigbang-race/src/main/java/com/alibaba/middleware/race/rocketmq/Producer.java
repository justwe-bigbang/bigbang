...
import com.alibaba.middleware.race.KryoUtils;
    ...
    public static void main(String[] args) throws MQClientException, InterruptedException {
        ...
        for (int i = 0; i < count; i++) {
            try {
                ...
                byte [] body = KryoUtils.serialize(orderMessage);
                ...
                for (final PaymentMessage paymentMessage : paymentMessages) {
                    ...
                    if (retVal > 0) {
                        ...
                        final Message messageToBroker = new Message(RaceConfig.MqPayTopic, KryoUtils.serialize(paymentMessage));
